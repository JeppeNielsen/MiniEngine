...
void Box::FromMatrix(const Matrix3x3 &matrix) {
...
void Box::FromMatrix(const Vector2 &topLeft, 
...
Box Box::Deserialize(const std::string &data) {
    std::vector<float> v;
