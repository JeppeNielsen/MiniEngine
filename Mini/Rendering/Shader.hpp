...
public:
    ...
    virtual void RenderObject(Mini::VertexRenderer<V>& renderer, const typename Mini::VertexMesh<V>::Vertices& vertices, const Mini::IVertexMesh::Triangles& triangles, const Mini::Matrix4x4& world);
};
}
