...
void DeferredRenderSystem::AddedToWorld(Mini::GameWorld &world) {
    ...
    if (!opaqueObjects.empty()) {
        ...
        
        {
            ...
            for (size_t i=0; i<renderList.size(); i++) {
                ...
                defferedLight.SetLightProperties(lightPosition, Color::White(), light->Radius, light->Brightness);
...
void DeferredRenderSystem::UpdateFromObject(Mini::GameObject *object) {
    VisibleObject* visibleObject = (VisibleObject*)GetMetaData(object);
    ApplyVisibleObject(visibleObject);
}
...
void DeferredRenderSystem::LightMeshSystem::ObjectAdded(Mini::GameObject *object) {
...
void DeferredRenderSystem::LightMeshSystem::ObjectRemoved(Mini::GameObject *object) {
    object->GetComponent<Light>()->Type.Changed -= event_handler(this, &DeferredRenderSystem::LightMeshSystem::LightChanged, object);
    object->GetComponent<Light>()->Radius.Changed -= event_handler(this, &DeferredRenderSystem::LightMeshSystem::LightChanged, object);
}

void DeferredRenderSystem::LightMeshSystem::LightChanged(Mini::Light *light, Mini::GameObject *object) {
...
void DeferredRenderSystem::LightMeshSystem::UpdateMesh(Mini::GameObject *object) {
